  ...
  return (
    <div className="flex flex-wrap gap-3 mb-6">
      ...
      <select
        ...
        className="px-4 py-2 rounded-xl border border-gray-200 bg-white text-sm focus:border-primary-400 focus:ring-2 focus:ring-primary-100 outline-none"
      >
      ...
      {(filters.type || filters.category || filters.month) && (
        <button
          onClick={() => onChange({})}
          className="px-4 py-2 rounded-xl text-sm text-primary-500 hover:bg-primary-50 transition-colors"
        >
          Reset filter
        </button>
      )}
